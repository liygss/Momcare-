...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $risiko_tinggi_status = 0; // Default: 0 = Normal
    if ($skor_poedji_rochjati >= 6 && $skor_poedji_rochjati <= 10) {
        $risiko_tinggi_status = 1; // 1 = Risiko Tinggi
    } elseif ($skor_poedji_rochjati >= 12) {
        $risiko_tinggi_status = 2; // 2 = Risiko Sangat Tinggi
    }
    // Jika skor adalah 2, maka akan tetap 0 (Normal) sesuai kriteria "2 sebagai angka normal".
    // Angka selain 2, 6-10, atau >=12 akan otomatis masuk ke default 0 jika tidak ada kondisi lain.
